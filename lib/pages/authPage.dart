...
class _AuthPageState extends State<AuthPage> {
  ...
  register(){
    if(registerKey.currentState!.validate()){
      ...
      api.regsiter(name, email.trim(), password,"driver", context).then((value) {
        if(value){
          Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(
              builder: (context) =>  const MovingPage()), (Route route) => false);
        }else{
          setState(() {
            isloading=false;
          });
                                ...
                                children:<Widget> [
                                  ...
                                  SizedBox(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      child: isloading?CircularProgressIndicator(color: Colors.white,): Text("Sign In",style: TextStyle(color:Colors.white,fontSize: 16),
                                      ),onPressed: (){
                                        login();
                                    },
                                    ),
                                ...
                                children:<Widget> [
                                  ...
                                  SizedBox(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      child: isloading?CircularProgressIndicator(color: Colors.white,): Text("Sign Up",style: TextStyle(color:Colors.white,fontSize: 16),
                                      ),onPressed: (){
                                        register();
                                    },
                                    ),
